    ...
    <form action="{{ route('business.update', $business->id) }}" enctype="multipart/form-data" class="form mdb-color-text" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <input type="text" name="meta[key][]" class="form-control" value="{{ $key }}" placeholder="key">
                    </div>
                    <div class="col-md-6">
                        <input type="text" name="meta[value][]" class="form-control" value="{{ $value }}" placeholder="value">
                    </div>
                </div>
				@endforeach
				@endif
