            ...
            <div class="col-md-8">
                <div class="p-4">
                    <div class="row">
                        ...
                        @if($business->metas)
                        <div class="col-md-12">
                            <div class="white p-3 my-4">
                                <table class="table table-hover table-borderless table-striped">
                                    @foreach($business->metas as $key => $value)
                                    <tr>
                                        <th>{{ $key }}</th>
                                        <td>{{ $value }}</td>
                                    </tr>
                    ...
                    <div class="mt-2">
                        ...
                        <iframe class="w-100 z-depth-1" height="500" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=place_id:{{ $business->map_id }}&key=AIzaSyD8fOm6lOT1YqsXVlXIBPSV-8gbCOf7Dr8" allowfullscreen></iframe>
                    </div>
